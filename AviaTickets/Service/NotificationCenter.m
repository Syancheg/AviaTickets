...
- (void)userNotificationCenter:(UNUserNotificationCenter *)center didReceiveNotificationResponse:(UNNotificationResponse *)response withCompletionHandler:(void (^)(void))completionHandler{
    Ticket *ticket = [[CoreDataHelper sharedInstance] getNotificationTicket:response.notification.date];
    NotificationTicketView *view = [[NotificationTicketView alloc] initWithTicket:ticket];
    [view show];
}
